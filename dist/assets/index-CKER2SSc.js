...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ua(e,t,n){let r=new Float32Array(ka),i=new K(0,1,0);return new xi({name:`SphericalGaussianBlur`,defines:{n:ka,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ka(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wa(){return new xi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ka(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ga(){return new xi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ka(),fragmentShader:`
	...
	`}var qa=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,xl=96,Sl=1.4,Cl=2;function wl(e,t){let n=new fi(Sl,Cl,xl,xl),r=new K(.4,.6,1).normalize(),i=new xi({vertexShader:yl,fragmentShader:bl,uniforms:{tDiffuse:{value:t.diffuse},tNormal:{value:t.normal},uLight:{value:r},uAmbient:{value:.4},uGrain:{value:.55},uDistortion:{value:.5},uCurvature:{value:.4},uSpineTaper:{value:.3},uTime:{value:0}},side:2}),a=new Jr(n,i);e.add(a);function o({curvature:e,spineTaper:t,ambient:n,grain:r,distortion:a}){e!==void 0&&(i.uniforms.uCurvature.value=e),t!==void 0&&(i.uniforms.uSpineTaper.value=t),n!==void 0&&(i.uniforms.uAmbient.value=n),r!==void 0&&(i.uniforms.uGrain.value=r),a!==void 0&&(i.uniforms.uDistortion.value=a)}function s({diffuse:e,normal:t}={}){e&&(i.uniforms.tDiffuse.value=e),t&&(i.uniforms.tNormal.value=t)}return{mesh:a,updateUniforms:o,updateTextures:s}}function Tl(e,t,n,r){let i=e.domElement.width,a=e.domElement.height;e.setSize(r,r,!1),e.render(t,n);let o=e.domElement.toDataURL(`image/png`);e.setSize(i,a,!1);let s=document.createElement(`a`);s.href=o,s.download=`bookpage-${Date.now()}.png`,s.click()}var $=e=>document.getElementById(e),El=$(`text-input`),Dl=$(`font-size`),Ol=$(`font-size-val`),kl=$(`ink-color`),Al=$(`ink-opacity`),jl=$(`ink-opacity-val`),Ml=$(`ink-distortion`),Nl=$(`ink-distortion-val`),Pl=$(`paper-style`),Fl=$(`grain`),Il=$(`grain-val`),Ll=$(`ambient`),Rl=$(`ambient-val`),zl=$(`curvature`),Bl=$(`curvature-val`),Vl=$(`spine`),Hl=$(`spine-val`),Ul=$(`rot-x`),Wl=$(`rot-x-val`),Gl=$(`rot-y`),Kl=$(`rot-y-val`),ql=$(`rot-z`),Jl=$(`rot-z-val`),Yl=$(`export-res`),Xl=$(`btn-render`),Zl=$(`btn-export`),Ql=$(`viewport`),$l=$(`loading`),eu=new Mc({antialias:!0,preserveDrawingBuffer:!0});eu.setPixelRatio(Math.min(window.devicePixelRatio,2)),eu.setClearColor(1710618),Ql.appendChild(eu.domElement);var tu=new jn,nu=new Ji(40,1,.01,100);nu.position.set(0,0,3.5);var ru=new Hc(nu,eu.domElement);ru.enableDamping=!0,ru.dampingFactor=.08,ru.minDistance=1,ru.maxDistance=8;var iu;function au(){cancelAnimationFrame(iu),(function e(){iu=requestAnimationFrame(e),ru.update(),eu.render(tu,nu)})()}new ResizeObserver(()=>ou()).observe(Ql);function ou(){let e=Ql.clientWidth,t=Ql.clientHeight;eu.setSize(e,t,!1),nu.aspect=e/t,nu.updateProjectionMatrix()}function su(e){let t=new si(e);return t.colorSpace=Le,t.needsUpdate=!0,t}function cu(e){let t=new si(e);return t.colorSpace=Re,t.needsUpdate=!0,t}var lu=null,uu=null,du=null,fu=1024,pu=`Paper001_4K-JPG`,mu=`Paper001_4K_`,hu=`/${pu}/${mu}Color.jpg`,gu=`/${pu}/${mu}NormalGL.jpg`,_u=null,vu=null;async function yu(){let e=parseInt(Fl.value,10)/100;try{return await sl(hu,fu)}catch{return dl(fu,Pl.value,e)}}async function bu(e){if(vu===`real`&&_u)return _u;try{return _u=await cl(gu,fu),vu=`real`,_u}catch{return fl(e)}}async function xu(){$l.classList.remove(`hidden`),await new Promise(e=>requestAnimationFrame(e));let e=al({text:El.value||` `,canvasSize:fu,fontSize:parseInt(Dl.value,10),color:kl.value,opacity:parseInt(Al.value,10)/100}),t=await yu(),n=await bu(t),r=vl(t,e);uu&&uu.dispose(),du&&du.dispose(),uu=su(r),du=cu(n),lu?lu.updateTextures({diffuse:uu,normal:du}):lu=wl(tu,{diffuse:uu,normal:du}),Su(),Cu(),$l.classList.add(`hidden`)}function Su(){lu&&lu.updateUniforms({curvature:parseInt(zl.value,10)/100,spineTaper:parseInt(Vl.value,10)/100,ambient:parseInt(Ll.value,10)/100,grain:parseInt(Fl.value,10)/100,distortion:parseInt(Ml.value,10)/100})}function Cu(){if(!lu)return;let e=e=>e*Math.PI/180;lu.mesh.rotation.x=e(parseInt(Ul.value,10)),lu.mesh.rotation.y=e(parseInt(Gl.value,10)),lu.mesh.rotation.z=e(parseInt(ql.value,10))}function wu(e,t,n){e.addEventListener(`input`,()=>{t.textContent=n(e.value)})}wu(Dl,Ol,e=>e),wu(Al,jl,e=>e+`%`),wu(Ml,Nl,e=>e+`%`),wu(Fl,Il,e=>e+`%`),wu(Ll,Rl,e=>e+`%`),wu(zl,Bl,e=>e+`%`),wu(Vl,Hl,e=>e+`%`),wu(Ul,Wl,e=>e+`°`),wu(Gl,Kl,e=>e+`°`),wu(ql,Jl,e=>e+`°`),[zl,Vl,Ll,Fl,Ml].forEach(e=>e.addEventListener(`input`,Su)),[Ul,Gl,ql].forEach(e=>e.addEventListener(`input`,Cu)),Xl.addEventListener(`click`,xu);var Tu;function Eu(){clearTimeout(Tu),Tu=setTimeout(xu,600)}[El,kl].forEach(e=>e.addEventListener(`input`,Eu)),Pl.addEventListener(`change`,()=>{_u=null,vu=null,Eu()}),[Dl,Al].forEach(e=>e.addEventListener(`change`,Eu)),Zl.addEventListener(`click`,()=>{Tl(eu,tu,nu,parseInt(Yl.value,10))}),ou(),xu(),au();